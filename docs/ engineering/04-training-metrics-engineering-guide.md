...
本文档面向开发工程师，定义训练指标的数据范围、分组、算法、空值规则和趋势规则。

相关 UI 设计见 `docs/03-training-metrics-ui-guide.md`。

## 架构约束

实现必须遵循 `docs/01-architecture.md`：
...
timerOnly 训练仍保留动作指标结构，但力量类 7 个核心指标全部为 `nil`。
